...
mybtn.addEventListener("click",function(e){
    ...
    {
      document.querySelector(".art").innerHTML=`<h3 class="alert alert-warning  text-center">Plz. Type Value</h3>`;
      return false;
    }else{
        document.querySelector(".art").classList.add("hid");
...
let sss =()=>{
     ...
     document.querySelector(".remove").innerHTML=`<h3 class="alert alert-danger  text-center"> Deltte All</h3>`
